...
#define DEVICE_ID "f363c4e7183c4d78aeec21abc966a74c"
#define DEVICE_TOKEN "59c21ffcc5184c5ba8d1397470284533"
...
int main(int argc, char *argv[]) {
    ...
    // 아틱 시간 설정
    setCurrentTime(2017, 9, 11, 22, 7, 0);
	date_showtime();
    ...
    while(1) {
		...
		if(sample.am_channel == 1){
			mqttDataLen = snprintf(mqttData, sizeof(mqttData), "{\"urineBag\":%d}", sample.am_data);
